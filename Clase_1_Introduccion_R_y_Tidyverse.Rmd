...
Existe una función muy útil para filtrar una variable dentro de un rango de valores numéricos. Esta función se llama `between()` y tiene 3 argumentos:
* El nombre de la variable que queremos filtrar.
* El valor mínimo que queremos usar de filtro.
* El valor máximo.
